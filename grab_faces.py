...
for walk_dir, dirs, files in os.walk(photo_dir):
    for image_name in files:
        ...
        for face_location in face_locations:
            ...
            face_count += 1
            face_file_name = faces_folder + "face_" + str(randint(1, 1000000)) + ext.lower()
            cv2.imwrite(face_file_name, image)
        
            logging.info("Processed image {} and saved to {}, face count {}".format(image_name, face_file_name, face_count))
